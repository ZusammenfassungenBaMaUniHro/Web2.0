...
var Person = function (name) {this.name = name;}.
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			Erziele 90\% des Verkauserfolgs mit 10\% der Produkte)
		\end{itemize}
		...
		\item Modell von Erdös und Renyi = Knoten werden zufällig ausgewählt – kann Power Law nicht erzeugen
		\item Modell von Barabasi und Albert = Preferential Attachment Modell (Wer hat dem wird gegeben d.h. neue Knoten verbinden sich zufällig mit ausgewähltem alten Knoten); Wahrscheinlichkeit fürs Verbindne steigt linear mit der Sichtbarkeit des alten Knotens $\rightarrow$ erzeugt Power Law Netzwerke
		...
		\end{itemize}
		\item es gilt also: Zeichnet sich bereits ein Monopolist ab, so ist Konkurrenz zwecklos
